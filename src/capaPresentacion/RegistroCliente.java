        ...
        registro1Layout.setHorizontalGroup(
            ...
            .addGroup(registro1Layout.createSequentialGroup()
                .addGroup(registro1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(registro1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(registro1Layout.createSequentialGroup()
                            .addContainerGap()
                            .addComponent(Salir, javax.swing.GroupLayout.PREFERRED_SIZE, 380, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, registro1Layout.createSequentialGroup()
                            .addGap(151, 151, 151)
    ...
    private void listaNomina(){
     ...
     private void Agregar(){
        ...
        if (Cedula.equals("")||Nombre.equals("")||Correo.equals("")){
            ...
            String sql="insert into clientes (Cedula,Nombre,Apellido,Celular,Correo)values('"+Cedula+"','"+Nombre+"','"+Apellido+"','"+Celular+"','"+Correo+"')";
            try{
                cn=con.getConnection();
                st=cn.createStatement();
     ...
     private void modificar(){
        ...
        String Celular=txtCelular.getText();
        String Correo=txtCorreo.getText();
        String sql ="update clientes set Cedula='"+ Cedula +"',Nombre='" + Nombre + "',Apellido='" + Apellido + "',Celular='" + Celular + "',Correo='" + Correo + "' where Cedula=" + Cedula;
